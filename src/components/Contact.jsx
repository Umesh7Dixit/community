...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (validate()) {
      try {
        await emailjs.send(
          "service_p3hqh4p",  // Replace with your actual EmailJS Service ID
          "template_mwda9sw", // Replace with your actual EmailJS Template ID
          {
          ...
          "_pX1z7Nk9u-n51K6z" // Replace with your actual EmailJS Public Key
        );
